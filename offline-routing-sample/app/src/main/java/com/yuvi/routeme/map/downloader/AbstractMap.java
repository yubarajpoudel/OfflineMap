...
public abstract class AbstractMap {
    ...
    public static AbstractMap instance() {
        if (mReference == null || mReference.get() == null) {
            mReference = new WeakReference<AbstractMap>(new NepalMap());
        }
    ...
    protected abstract String getShorcutFastestCar();
    protected abstract String getNodesFastestCar();
    ...
    public File getShortcutfastedCarFile(@NonNull Context context) {
        return new File(getOfflineMapsDir(context), "shortcuts_fastest_car");
    }
    public File getNodesFastestCarFile(@NonNull Context context) {
        return new File(getOfflineMapsDir(context), "nodes_ch_fastest_car");
    }
