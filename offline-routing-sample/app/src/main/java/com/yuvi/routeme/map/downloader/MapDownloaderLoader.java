...
import static com.yuvi.routeme.util.LogUtils.makeLogTag;
...
public class MapDownloaderLoader extends AsyncTaskLoader<Boolean> {
    ...
    protected static final String TAG = makeLogTag(MapDownloaderLoader.class);
    ...
    public Boolean loadInBackground() {
        ...
        list.add(new Pair<>(mSelectedMap.getNodesFastestCar(), mSelectedMap.getNodesFastestCarFile(context)));
        list.add(new Pair<>(mSelectedMap.getShorcutFastestCar(), mSelectedMap.getShortcutfastedCarFile(context)));
        final File targetDir = mSelectedMap.getOfflineMapsDir(context);
        LOGD(TAG, "DownloadFileList size = " + list.size());
